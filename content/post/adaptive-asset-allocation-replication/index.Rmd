...
stats <- strat_summary(returns_equal_weight, title,
...
stats <- strat_summary(returns_equal_risk, title,
...
stats <- strat_summary(returns_momo_equal_weight, title,
...
stats <- strat_summary(returns_momo_equal_risk, title,
...
returns_momo_min_var <-
    portf_return_momo_min_var(returns, 5, 120, 60) |>
    to_monthly_returns()

title <- "Assets With Above Average 6-month Momentum - Minimum Variance"
stats <- strat_summary(returns_momo_min_var, title,
