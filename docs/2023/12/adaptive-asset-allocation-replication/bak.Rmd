...
```{r equal_risk_functions, echo=FALSE}
...
```{r top5_momo_eq_weight_functions, echo=FALSE}
portf_top_momentum <-
function(returns,
         n_assets = 5,
         n_days = 120)
...
```{r top_momo_eq_risk_functions, echo=FALSE}
...
```{r top_momo_min_var_functions, echo=FALSE}
